        ...
        contactForm.addEventListener('submit', function(e) {
            ...
            if (isValid) {
                ...
                if (submitButton) {
                    ...
                    submitButton.textContent = submitButton.value = 'Sending...';
                    
                    setTimeout(() => {
                        submitButton.textContent = submitButton.value = 'Sent!';
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '9ecba034-7754-4363-b43b-f8e9e8eeff29',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '9ecba034-7754-4363-b43b-f8e9e8eeff29';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '9ecba034-7754-4363-b43b-f8e9e8eeff29';
